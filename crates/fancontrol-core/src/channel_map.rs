...
impl ChannelMap {
    ...
    pub fn owner_nct668_seed() -> Self {
        ...
        let controls = [
            ...
            ("pawnio.0.ctrl9", "Sys fan 9 (EC)"),
            ("pawnio.0.ctrl10", "Sys fan 10 (EC)"),
            ("pawnio.0.ctrl11", "Sys fan 11 (EC)"),
            ("pawnio.0.ctrl12", "Sys fan 12 (EC)"),
            ("pawnio.0.ctrl13", "Sys fan 13 (EC)"),
            ("pawnio.0.ctrl14", "Sys fan 14 (EC)"),
            ("pawnio.0.ctrl15", "Sys fan 15 (EC)"),
