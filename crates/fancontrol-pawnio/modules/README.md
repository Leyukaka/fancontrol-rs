...
| `SmbusPIIX4.bin` | AMD chipset SMBus controller (`ioctl_smbus_xfer`) — experimental DDR5 DIMM temperature, read-only |
| `SmbusI801.bin` | Intel chipset SMBus controller (`ioctl_smbus_xfer`) — experimental DDR5 DIMM temperature, read-only |
