...
- Product line: **v0.5.5**. Roadmap and feature checklist: `specs/06-roadmap.md`.
...
- UI: egui 0.36, domain panels, multi-kind graph, activity deck, i18n (8 locales), manual update check only, tray-icon 0.25 with a frozen Windows GUID. `specs/04-ui.md`.
